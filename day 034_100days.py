...
def spam(num):
	for i  in range(0,num):
	  ...
	  It has come to our attention that you're missing out on the amazing Replit 100 days of code.
		We insist you do it right away. If you don't we will pass on your email address to every 
	  spammer we've ever encountered and also sign you up to the My Little Pony newsletter, because 
...
while True:
  ...
  if menu == "1":
   ...
   pause = input("press anykey to countinue")
